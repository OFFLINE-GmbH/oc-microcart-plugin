...
class PayPalRest extends PaymentProvider
{
    ...
    public function process(PaymentResult $result): PaymentResult
    {
        ...
        Session::put('microCart.paypal.transactionReference', $response->getTransactionReference());
    ...
    {
        $key     = Session::pull('microCart.paypal.transactionReference');
    ...
    public function settings(): array
    {
        return [
            'paypal_test_mode' => [
                'label'   => 'offline.microcart::lang.payment_gateway_settings.paypal.test_mode',
                'comment' => 'offline.microcart::lang.payment_gateway_settings.paypal.test_mode_comment',
                'span'    => 'left',
                'type'    => 'switch',
            ],
            'paypal_client_id' => [
                'label' => 'offline.microcart::lang.payment_gateway_settings.paypal.client_id',
                'span'  => 'left',
                'type'  => 'text',
            ],
            'paypal_secret'    => [
                'label' => 'offline.microcart::lang.payment_gateway_settings.paypal.secret',
                'span'  => 'left',
                'type'  => 'text',
            ],
        ];
